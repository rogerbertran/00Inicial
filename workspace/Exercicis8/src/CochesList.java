...
public class CochesList {
	...
	public static void main(String[] args) {
		...
		// Sí es poden afegir duplicats.
		
		// creates a new car and offers it into the position 1
		Car car8 = new Car("Audi","A8",4600,8);
		
		// Doesn't let's us to add the car into the position 1 'carsList.offer(1,car8);'
		...
		for (Car c : carsList) {
			if (c.getMarca() == "Hyundai" && c.getModel() == "Atos") {
				System.out.println("El Hyundai està a la posició: " + carsList.indexOf(c));
			}
		}
